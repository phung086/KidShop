...
<head>
    ...
    <!-- jQuery JS -->
    <script src="{{asset('kidolshop/js/vendor/jquery-3.3.1.min.js')}}"
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="header-logo">
                                <a href="{{URL::to('/home')}}"><img src="{{asset('kidolshop/images/logo/logo.png')}}"
                                        alt=""></a>
                            </div>
                        </div>
                                                ...
                                                <li class="mega-dropdown">
                                                    ...
                                                    <ul class="mega-item">
                                                        ...
                                                        <li><a href="{{URL::to('/store?show=all&sort_by=featured')}}">Sản
                                                                phẩm nổi bật</a></li>
                                                        <li><a href="{{URL::to('/store?show=all&sort_by=sale')}}">Sản
                                                                phẩm đang SALE</a></li>
                                                    </ul>
                                                </li>
                                                <li class="mega-dropdown">
                                                    <a class="menu-banner" href="#">
                                                        <img src="{{asset('kidolshop/images/banner-navbar.jpg')}}"
                                                            alt="">
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="header-account">
                                    <div class="header-account-list dropdown top-link">
                                        ...
                                        <a href="#" role="button" data-toggle="dropdown"><img style="border-radius:50%;"
                                                ...
                                                src="{{asset('storage/kidoldash/images/customer/'.Session::get('AvatarCus'))}}"
                                                alt=""></a>
                                    ...
                                    <div class="header-account-list dropdown mini-cart">
                                        ...
                                        <ul class="dropdown-menu ">
                                            <li class="product-cart">
                                                ...
                                                $SalePrice = 0;
                                                if($get_time_sale) $SalePrice = $cart->Price - ($cart->Price/100) *
                                                $get_time_sale->Percent;
                                                @endphp
                                                <div class="single-cart-box">
                                                    ...
                                                    <div class="cart-content">
                                                        ...
                                                        <div class="cart-price d-flex">
                                                            @if($SalePrice != '0')
                                                            <span
                                                                class="sale-price">{{number_format(round($SalePrice,-3),0,',','.')}}đ</span>
                                                            <span
                                                                class="regular-price">{{number_format($cart->Price,0,',','.')}}đ</span>
                                                            @else
                                                            <span
                                                                class="sale-price">{{number_format($cart->Price,0,',','.')}}đ</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <ul class="dropdown-menu" style="height:250px; width:250px;">
                                            <li
                                                ...
                                                <img src="{{asset('kidolshop/images/no_cart.png')}}" alt=""
                                ...
                                <li class="mega-dropdown">
                                    ...
                                    <ul class="mega-item">
                                        ...
                                        <li><a href="{{URL::to('/store?show=all&sort_by=featured')}}">Sản phẩm nổi
                                                bật</a></li>
                                        <li><a href="{{URL::to('/store?show=all&sort_by=sale')}}">Sản phẩm đang SALE</a>
                                        </li>
                                    </ul>
                                </li>
                                <!-- <li class="mega-dropdown">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="footer-widget">
                                <a class="footer-logo" href="#"><img src="{{asset('kidolshop/images/logo/logo.png')}}"
                                        alt=""></a>
                                <div class="footer-widget-text">
                                    <p>Một chiếc áo sơ mi đẹp sẽ ảnh hưởng rất nhiều đến phong thái và tâm trạng của
                                        người mặc. Và việc chọn được một... Xem thêm</p>
                                </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6">
                            <div class="footer-widget">
                                <h4 class="footer-widget-title">Tài khoản</h4>
            ...
            <div class="container">
                <div class="copyright-wrapper text-center d-lg-flex align-items-center justify-content-between">
                    ...
                    <div class="copyright-content">
                        <p>Copyright 2025 &copy; <a href="https://www.facebook.com/pham.hung.086?locale=vi_VN">Phạm Đình Hưng</a> . All Rights
                            Reserved</p>
                    </div>
                    <!--Right End-->
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('.btn-compare').on('click', function() {
                            ...
                            window.location.href = '../kidolshop/compare?product=' +
                                idProduct + cmp_pro;
                        });
                    }
                });
