        ...
        <div class="iq-sidebar  sidebar-default ">
            <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
                <a href="{{URL::to('/dashboard')}}" class="header-logo">
                    <img src="{{asset('kidoldash/images/logo.png')}}" class="img-fluid rounded-normal light-logo"
                        alt="logo">
...
if ($position != 'Nhân Viên') {
                    ...
                    <div class="card border-none">
                        <div class="card-body p-0">
                            <div class="sidebarbottom-content">
                                <div class="image"><img src="{{asset('kidoldash/images/layouts/side-bkg.png')}}"
            ...
            <div class="iq-navbar-custom">
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                    <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{URL::to('/dashboard')}}" class="header-logo">
                            <img src="{{asset('kidoldash/images/logo.png')}}" class="img-fluid rounded-normal"
                                alt="logo">
                            ...
                            <ul class="navbar-nav ml-auto navbar-list align-items-center">
                                        ...
                                        <div class="card shadow-none m-0">
                                            <div class="card-body p-3">
                                                <a class="iq-sub-card" href="#"><img
                                                        src="{{asset('kidoldash/images/small/flag-02.png')}}"
                                                        alt="img-flag" class="img-fluid mr-2">French</a>
                                                <a class="iq-sub-card" href="#"><img
                                                        src="{{asset('kidoldash/images/small/flag-03.png')}}"
                                                        alt="img-flag" class="img-fluid mr-2">Spanish</a>
                                                <a class="iq-sub-card" href="#"><img
                                                        src="{{asset('kidoldash/images/small/flag-04.png')}}"
                                                        alt="img-flag" class="img-fluid mr-2">Italian</a>
                                                <a class="iq-sub-card" href="#"><img
                                                        src="{{asset('kidoldash/images/small/flag-05.png')}}"
                                                        alt="img-flag" class="img-fluid mr-2">German</a>
                                                <a class="iq-sub-card" href="#"><img
                                                        src="{{asset('kidoldash/images/small/flag-06.png')}}"
                                                ...
                                                <div class="px-3 pt-0 pb-0 sub-card">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="">
                                                                <img class="avatar-50 rounded-small"
                                                                    src="{{asset('kidoldash/images/user/01.jpg')}}"
                                                                    alt="01">
                                                            </div>
                                                    ...
                                                    <a href="#" class="iq-sub-card">
                                                        <div
                                                            ...
                                                            <div class="">
                                                                <img class="avatar-50 rounded-small"
                                                                    src="{{asset('kidoldash/images/user/02.jpg')}}"
                                                                    alt="02">
                                                            </div>
                                                            <div class="media-body ml-3">
                                                                <div
                                                    ...
                                                    <a href="#" class="iq-sub-card">
                                                        <div class="media align-items-center cust-card py-3">
                                                            <div class="">
                                                                <img class="avatar-50 rounded-small"
                                                                    src="{{asset('kidoldash/images/user/03.jpg')}}"
                                                                    alt="03">
                                                            </div>
                                                            <div class="media-body ml-3">
                                                                <div
                                                ...
                                                <div class="px-3 pt-0 pb-0 sub-card">
                                                    <a href="#" class="iq-sub-card">
                                                        <div
                                                            ...
                                                            <div class="">
                                                                <img class="avatar-50 rounded-small"
                                                                    src="{{asset('kidoldash/images/logo.png')}}"
                                                                    alt="01">
                                                            </div>
                                                            <div class="media-body ml-3">
                                                                <div
                                                                ...
                                                                <small class="mb-0">Đã đến thời gian sao lưu dữ liệu,
                                                                    nhấn để xem chi tiết!</small>
                                                            </div>
                                                        </div>
                                                    </a>
                                                    <a href="#" class="iq-sub-card">
                                                        <div
                                                            ...
                                                            <div class="media-body ml-3">
                                                                ...
                                                                <small class="mb-0">Đã đến thời gian bảo trì hệ thống,
                                                                    nhấn để xem chi tiết!</small>
                                                            </div>
                                                        </div>
                                                    </a>
                                ...
                                <li class="nav-item nav-icon dropdown caption-content">
                                    <a href="#" class="search-toggle dropdown-toggle" id="dropdownMenuButton4"
                                        ...
                                        @else
                                        <img src="{{asset('kidoldash/images/user/12.jpg')}}" class="img-fluid rounded"
                                            alt="user">
                                        @endif
                                    </a>
                                    <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <div class="card shadow-none m-0">
                                            <div class="card-body p-0 text-center">
                                                <div class="media-body profile-detail text-center">
                                                    <img src="{{asset('kidoldash/images/page-img/profile-bg.jpg')}}"
                                                    ...
                                                    @else
                                                    <img src="{{asset('kidoldash/images/user/12.jpg')}}"
                                                        alt="profile-img"
                                                        class="rounded profile-img img-fluid avatar-70">
                                                    @endif
                                                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-right">
                            ...
                            </span> <a href="#" class="">Phạm Đình Hưng</a>.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{asset('kidoldash/datetimepicker-master/jquery.datetimepicker.css')}}">
