            ...
            if($(this).is(":checked")){
                ...
                $(document).ready(function(){
                    $("#confirm").click(function(){
                        ...
                        $(".list-product").append('<div class="product-item col-md-2" id=product-list-item-'+ product_id +'><div class="product-image" id=product-list-image-'+ product_id +'><img src="storage/kidoldash/images/product/'+ product_img +'" class="rounded w-100 img-fluid"><div class="product-title"><div class="product-name"><span>'+product_name+'</span></div></div></div></div>');
                    })
                })
            }
