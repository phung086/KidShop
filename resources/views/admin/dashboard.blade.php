                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-info-light">
                                        <img src="kidoldash/images/product/1.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4 card-total-sale">
                                    <div class="icon iq-icon-box-2 bg-success-light">
                                        <img src="kidoldash/images/product/3.png" class="img-fluid" alt="image">
                                    </div>
                                    <div>
                                ...
                                <div class="card card-block card-stretch mb-0">
                                    <div class="card-body">
                                        <div class="bg-warning-light rounded">
                                            ...
                                            <img src="{{asset('storage/kidoldash/images/product/'.$image)}}" class="style-img img-fluid m-auto p-3" alt="image">
                                        </div>
                    ...
                    <div class="card-body--AllTime card-item-right">
                        <div class="d-flex align-items-top">
                            <div class="iq-avatar d-flex align-items-center">
                                ...
                                <img src="{{asset('storage/kidoldash/images/product/'.$image)}}" class="p-0 avatar-100 style-img img-fluid m-auto rounded" alt="image">
                            </div>
