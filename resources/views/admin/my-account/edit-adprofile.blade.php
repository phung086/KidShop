                                            ...
                                            <div class="profile-img-edit">
                                                <div class="crm-profile-img-edit">
                                                    @if(Session::get('Avatar') != NULL)
                                                        <img class="crm-profile-pic rounded-circle avatar-100 replace-avt" src="storage/kidoldash/images/user/<?php echo Session::get('Avatar')?>" alt="profile-pic">
                                                    @else
                                                        <img class="crm-profile-pic rounded-circle avatar-100 replace-avt" src="kidoldash/images/user/12.jpg" alt="profile-pic">
                                                    @endif
