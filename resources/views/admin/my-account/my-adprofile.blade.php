            ...
            <div class="col-lg-12">
                <div class="card car-transparent">
                    <div class="card-body p-0">
                        ...
                        <img src="kidoldash/images/page-img/profile.png" class="img-fluid rounded w-100" alt="profile-image">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-3">
                            <div class="profile-img position-relative">
                                ...
                                @else
                                    <img src="kidoldash/images/user/12.jpg" class="img-fluid rounded avatar-110" alt="profile-image">
                                @endif
                            </div>
                            <div class="ml-3">
