...
class CartController extends Controller
{
        ...
        if ($request->vnp_TransactionStatus && $request->vnp_TransactionStatus == '00') {
            ...
            foreach ($get_cart as $key => $cart) {
                ...
                DB::table('product')
                    ...
                    ->decrement('QuantityTotal', $cart->QuantityBuy);
                ...
                DB::table('product_attribute')
                    ->where('idProAttr', $cart->idProAttr)
                    ->decrement('Quantity', $cart->QuantityBuy);
            }
    ...
    public function submit_payment(Request $request)
    {
        ...
        if ($data['checkout'] == 'vnpay') {
            ...
            $vnp_TxnRef = base64_encode(openssl_random_pseudo_bytes(30));
